...
export default function Hero8({
  ...
  return (
    ...
    >
      <div
        className="cs-hero cs-style3 cs-type1  cs-fixed_bg cs-shape_wrap_1 "
        style={{ background: "rgba(0,18,48,0.7)", height:"52rem" }}
      >
        <div className="container" >
          <div className="cs-hero_text">
            <h1 className="cs-hero_title" style={{ color: "#01ffcb" }}>
              {parse(title)}
            </h1>
        ...
        <div className="cs-hero_highlite cs-primary_color cs-accent_color cs-center" style={{bottom:0}} >
          {bannerHighlightText}
